...
if __name__ == "__main__":
    ...
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/O_BBN_sur_09_25.pickle', 'wb') as handle:
        pickle.dump(O_BBN_sur, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/O_Alan_sur_09_25.pickle', 'wb') as handle:
        pickle.dump(O_Alan_sur, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/O_Drop_all_09_25.pickle', 'wb') as handle:
        pickle.dump(O_Drop_all, handle, protocol=2)

    with open('/home/jiezou/Documents/Context_aware MCS/L_results/file_name_09_25.pickle', 'wb') as handle:
        pickle.dump(file_name, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/O_Dropped_diff_09_25.pickle', 'wb') as handle:
        pickle.dump(O_Dropped_diff, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/O_Dropped_diff_raw_09_25.pickle', 'wb') as handle:
        pickle.dump(O_Dropped_diff_raw, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/EU_mean_09_25.pickle', 'wb') as handle:
        pickle.dump(EU_mean, handle, protocol=2)
    with open('/home/jiezou/Documents/Context_aware MCS/L_results/EU_difference_holistic_09_25.pickle', 'wb') as handle:
