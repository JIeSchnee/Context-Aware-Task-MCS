...
def parameters_initialisation():
    ...
    cpd_tau9 = TabularCPD(variable='tau9', variable_card=2,
                          values=[[0.3],
                                  [0.7]],
                          )
    Taskset.append(Task(cpd_tau9.variable, cpd_tau9, 'HI'))

    cpd_tau10 = TabularCPD(variable='tau10', variable_card=2,
                           values=[[0.85, 0.01],
                                   [0.15, 0.99]],
                           evidence=['tau6'],
                           evidence_card=[2],
                           )
    Taskset.append(Task(cpd_tau10.variable, cpd_tau10, 'LO'))

    cpd_tau11 = TabularCPD(variable='tau11', variable_card=2,
                           values=[[0.9, 0.3, 0.85, 0.05],
                                   [0.1, 0.7, 0.15, 0.95]],
                           evidence=['tau9', 'tau10'],
                           evidence_card=[2, 2],
                           )
    Taskset.append(Task(cpd_tau11.variable, cpd_tau11, 'HI'))
...
def model_initialisation(Tasks):
    model = BayesianNetwork([('tau1', 'tau7'), ('tau6', 'tau7'), ('tau1', 'tau2'), ('tau2', 'tau5'), ('tau3', 'tau5'),
                             ('tau4', 'tau5'), ('tau8', 'tau5'), ('tau6', 'tau10'), ('tau9', 'tau11'), ('tau10', 'tau11')])
...
def Task_Dropping_Test(dropped_task_set, Tasks1, model1):
    ...
    Key_node_candidates = ['tau5', 'tau7', 'tau11']
