...
def Task_drop_and_update(app, Tasks_pre, model_pre, Appset, HI_group, Test_task_set, Task_drop_order, keynode):
    ...
    EU_local_set, Dropped_task = app_task_drop_test(app, Test_task_set, model_pre, tasks_name_index, HI_group, Appset, keynode)
...
if __name__ == "__main__":
    ...
    App_drop_task_order = []
    tasks_name_index = []
    [Tasks_original, model_original, Appset_original] = initialisation()
    ...
    for app in App_drop_order:
        ...
        while Test_task_set:
            ...
            HI_group, Test_task_set, temp_order, keynode)
